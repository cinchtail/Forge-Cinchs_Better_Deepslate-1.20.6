...
public class ModItems {
    ...
    public static final Item DEEPSLATE_AXE = registerItem("deepslate_axe",
            properties -> new AxeItem(ModToolMaterials.DEEPSLATE, 7.0F, -3.2F, new Item.Settings()
    ...
    public static final Item DEEPSLATE_SHOVEL = registerItem("deepslate_shovel",
            properties -> new ShovelItem(ModToolMaterials.DEEPSLATE, 1.5F, -3.0F, new Item.Settings()
